          ...
          <section id="nav-bar">
            <nav class="navbar navbar-expand-lg navbar-light">
              <div class="container-fluid">
                <a class="navbar-brand" href="alindex.php"><img src="{{URL('image/1619148608378.png')}}"></a>
                ...
                <span class="navbar-toggler-icon"></span>
                  ...
                  <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="{{ route('aboutal') }}">About</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="{{ route('serviceal') }}">Service</a>
                      </li>
                      @if (auth()->user()->role == 'user')
                      <li class="nav-item">
                        <a class="nav-link" href="{{ route('planning') }}">Plan Your Wedding</a>
                      </li>
                      @endif
                      @if (auth()->user()->role == 'admin')
                      <li class="nav-item">
                        <a class="nav-link" href="{{ route('tablepage') }}">Order</a>
                      </li>
                      @endif
                      <li class="nav-item">
                      ...
                      <!-- <li class="nav-item">
                        <a href="{{ route('profile') }}"><img src="{{URL('image/user logo.png')}}"></a>
                      </li> -->
                    </ul>
                  </div>
              </div>
